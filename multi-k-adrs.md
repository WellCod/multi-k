...
Arquivo único em vez de `docs/adr/NNNN-*.md`: com 1 dev e uso principal sendo colar como contexto para IA, um arquivo vence. Se o time crescer, quebra depois.
...
[corretora] → multi-K. Curto, carrega a marca sem explicação. "Multi-Kalculo" descartado: a troca de C por K em nome longo lê como marca de 2010, e o produto já está indo além de cotação (gestão, comissão, sinistro) — "Kalculo" ficaria pequeno.
