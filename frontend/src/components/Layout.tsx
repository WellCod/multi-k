...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="min-h-screen bg-canvas text-ink">
    ...
    <div className="min-h-screen flex flex-col lg:pl-16">
      ...
      <footer className="mt-auto border-t border-line px-4 py-3 text-xs text-muted flex flex-wrap justify-between gap-2"><span>multi-K — [corretora]</span><span>v{import.meta.env.VITE_APP_VERSION ?? "0.1.0"}</span></footer>
    </div>
