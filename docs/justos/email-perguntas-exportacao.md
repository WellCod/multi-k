...
> registrado no projeto é `lcardoso@justos.com`, usado para a chave pública EC.
...
**Assunto:** Integração Klubi × Justos — dúvidas sobre `GET /brokers/policy/export`

---

Olá, [nome],

Aqui é a **Klubi Corretora de Seguros**. Nossa integração com a API de vocês já
