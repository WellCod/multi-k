...
O nome sai da corretora — multi-K. Curto, carrega a marca sem explicação. "Multi-Kalculo" descartado: a troca de C por K em nome longo lê como marca de 2010, e o produto já está indo além de cotação (gestão, comissão, sinistro) — "Kalculo" ficaria pequeno.
